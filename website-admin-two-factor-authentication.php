<?php
/*
Plugin Name: Website Admin Two-Factor Authentication
Plugin URI: http://www.siteguarding.com/en/website-extensions
Description: Adds more security for admin login page. Two-Factor Authentication. Whitelist for trusted IP addresses.
Version: 1.0
Author: SiteGuarding.com
Author URI: https://SiteGuarding.com
*/ 
// rev.20200601
...
class WebsiteAdminTwoFactorAuthentication
{
	...
	public function addToLogin() {
        ...
        <p style="text-align:center;padding-bottom:15px">
                <a href="https://www.siteguarding.com/" target="_blank"><img style="height:35px" src="<?php echo plugins_url('images/logo_siteguarding.svg', __FILE__); ?>"/></a><br>
				Protected with SiteGuarding security plugin
        </p>
		<?php
	}
	...
	public function profile_personal_options() {
		...
		<?php if ( $is_profile_page || IS_PROFILE_PAGE ) : ?>
			...
			<p class="description">Learn more about Mobile App and Two-Factor Authentication Configuration <a href="https://www.siteguarding.com/en/two-factor-authentication-configuration" target="_blank">Click here</a></p>
			</td>
			</tr>
			<tr>
			<th></th>
